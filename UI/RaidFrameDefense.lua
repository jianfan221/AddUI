...
local CustomDefenseSpellIDs = {
	...
	[414661] = true, --寒冰护体(群体屏障分发的吸收盾)
	[414662] = true, --烈焰护体(群体屏障分发的吸收盾)
	[414663] = true, --棱光护体(群体屏障分发的吸收盾)
	...
	[6940] = true, --牺牲祝福(外)
	[204018] = true, --破咒祝福(外)
	[388010] = true, --暮秋祝福(四季·秋,给队友减伤)

	--战士
	[97463] = true, --集结呐喊
	[147833] = true, --援护(外,替队友承伤)
	[12975] = true, --破釜沉舟
	[871] = true, --盾墙(减伤40%)
	...
	[207771] = true, --烈火烙印
	[196718] = true, --黑暗(团队减伤)
	[209426] = true, --黑暗(团队减伤,另一ID)

	--德鲁伊
	[22812] = true, --树皮术
	[102342] = true, --铁木树皮(外,给队友减伤)
	[61336] = true, --生存本能
	[22842] = true, --狂暴回复(熊形态回血)
	[106898] = true, --狂奔怒吼
	[77761] = true, --狂奔怒吼(队友加速buff)
	[77764] = true, --狂奔怒吼(队友加速buff)
	[29166] = true, --激活
	[1850] = true, --疾奔
	...
	[374227] = true, --微风
	[357170] = true, --时间膨胀(外,减伤)
	[406789] = true, --空间悖论(位移)
	-- 时间螺旋：唤魔师本体 + 各职业收到的同名位移buff(按职业分发不同ID)
	[375234] = true, --时间螺旋(位移,唤魔师)
	[375226] = true, --时间螺旋(位移,死亡骑士)
	[375229] = true, --时间螺旋(位移,恶魔猎手)
	[375230] = true, --时间螺旋(位移,德鲁伊)
	[375238] = true, --时间螺旋(位移,猎人)
	[375240] = true, --时间螺旋(位移,法师)
	[375252] = true, --时间螺旋(位移,武僧)
	[375253] = true, --时间螺旋(位移,圣骑士)
	[375254] = true, --时间螺旋(位移,牧师)
	[375255] = true, --时间螺旋(位移,潜行者)
	[375256] = true, --时间螺旋(位移,萨满)
	[375257] = true, --时间螺旋(位移,术士)
	[375258] = true, --时间螺旋(位移,战士)
