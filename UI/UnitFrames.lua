...
ns.hook("UnitFrameHealthBar_OnUpdate", ADDUIUpdateHealthBar)
...
ns.event("PLAYER_LOGIN", function()
	...
	ns.hook(FocusFrame, "CheckClassification", FrameBar)
	ns.hook(TargetFrameToT, "Update", FrameBar)
	ns.hook(FocusFrameToT, "Update", FrameBar)
