...
ns.Defaults = {
	...
	zu = true, -- 密语自动邀请
	lfgkg = true, -- LFG增强
	raidRoleIcon = true, -- 团队框架职责图标
	raidMouseHighlight = true, -- 团队框架鼠标指向边框
	raidabsorb = true, -- 团队框架吸收盾
	raidframeDefense = true, -- 团队框架减伤监控
	stat = true, -- 自身属性框体
	cdset = true, -- 冷却管理器美化
	cdcenter = true, -- 冷却管理器居中对齐
	MDRedamage = true, -- 大秘境重置伤害统计
	...
	sayfocus = false, -- 关注说话
	hpUnits = 1, -- 单位数量
	DungeonBossKill = {}, -- 地城BOSS击杀时间记录（保留，不随恢复默认清除）
